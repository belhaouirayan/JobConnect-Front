...
const Pagination = ({ 
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between px-4 py-3 bg-white dark:!bg-gray-900 border-t border-gray-200 dark:!border-gray-800 gap-4 mt-2 rounded-lg shadow-sm">
      ...
      <div className="flex items-center gap-2 text-sm">
        <span className="text-gray-600 dark:!text-gray-300">{t("Go To") || "Aller à"}:</span>
        <select
          value={currentPage}
